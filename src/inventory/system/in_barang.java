 ...
 * @author CALAK
 */
public class in_barang extends javax.swing.JDialog {
     ...
     */
    public in_barang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(in_barang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                in_barang dialog = new in_barang(new javax.swing.JFrame(), true);
